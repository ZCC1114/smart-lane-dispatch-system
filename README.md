...
- 入口 DIDO 的 `A01-A09`：1-9 号车道入口红灯继电器；现场 10/11 号入口接线互反，10 号车道发 `A11`，11 号车道发 `A10`
- 出口 DIDO 的 `A01-A11`：1-11 号车道出口红灯继电器
...
当前按单继电器灯控：继电器吸合表示红灯，继电器关闭表示绿灯。如果现场红灯、绿灯是两个独立继电器，再额外填写 `APP_DEVICE_Lxx_ENTRY_GREEN_RELAY` 或 `APP_DEVICE_Lxx_EXIT_GREEN_RELAY`。

如果现场接线一致，下面这些默认值不用改：

```dotenv
APP_DEVICE_L01_ENTRY_RED_RELAY=A01
APP_DEVICE_L01_ENTRY_GREEN_RELAY=
APP_DEVICE_L01_EXIT_RED_RELAY=A01
APP_DEVICE_L01_EXIT_GREEN_RELAY=
APP_DEVICE_L01_EXIT_TRIGGER_INPUT_KEY=B01

APP_DEVICE_L02_ENTRY_RED_RELAY=A02
APP_DEVICE_L02_ENTRY_GREEN_RELAY=
APP_DEVICE_L02_EXIT_RED_RELAY=A02
APP_DEVICE_L02_EXIT_GREEN_RELAY=
APP_DEVICE_L02_EXIT_TRIGGER_INPUT_KEY=B02

APP_DEVICE_L03_ENTRY_RED_RELAY=A03
APP_DEVICE_L03_ENTRY_GREEN_RELAY=
APP_DEVICE_L03_EXIT_RED_RELAY=A03
APP_DEVICE_L03_EXIT_GREEN_RELAY=
APP_DEVICE_L03_EXIT_TRIGGER_INPUT_KEY=B03

APP_DEVICE_L04_ENTRY_RED_RELAY=A04
APP_DEVICE_L04_ENTRY_GREEN_RELAY=
APP_DEVICE_L04_EXIT_RED_RELAY=A04
APP_DEVICE_L04_EXIT_GREEN_RELAY=
APP_DEVICE_L04_EXIT_TRIGGER_INPUT_KEY=B04

APP_DEVICE_L05_ENTRY_RED_RELAY=A05
APP_DEVICE_L05_ENTRY_GREEN_RELAY=
APP_DEVICE_L05_EXIT_RED_RELAY=A05
APP_DEVICE_L05_EXIT_GREEN_RELAY=
APP_DEVICE_L05_EXIT_TRIGGER_INPUT_KEY=B05

APP_DEVICE_L06_ENTRY_RED_RELAY=A06
APP_DEVICE_L06_ENTRY_GREEN_RELAY=
APP_DEVICE_L06_EXIT_RED_RELAY=A06
APP_DEVICE_L06_EXIT_GREEN_RELAY=
APP_DEVICE_L06_EXIT_TRIGGER_INPUT_KEY=B06

APP_DEVICE_L07_ENTRY_RED_RELAY=A07
APP_DEVICE_L07_ENTRY_GREEN_RELAY=
APP_DEVICE_L07_EXIT_RED_RELAY=A07
APP_DEVICE_L07_EXIT_GREEN_RELAY=
APP_DEVICE_L07_EXIT_TRIGGER_INPUT_KEY=B07

APP_DEVICE_L08_ENTRY_RED_RELAY=A08
APP_DEVICE_L08_ENTRY_GREEN_RELAY=
APP_DEVICE_L08_EXIT_RED_RELAY=A08
APP_DEVICE_L08_EXIT_GREEN_RELAY=
APP_DEVICE_L08_EXIT_TRIGGER_INPUT_KEY=B08

APP_DEVICE_L09_ENTRY_RED_RELAY=A09
APP_DEVICE_L09_ENTRY_GREEN_RELAY=
APP_DEVICE_L09_EXIT_RED_RELAY=A09
APP_DEVICE_L09_EXIT_GREEN_RELAY=
APP_DEVICE_L09_EXIT_TRIGGER_INPUT_KEY=B09

APP_DEVICE_L10_ENTRY_RED_RELAY=A11
APP_DEVICE_L10_ENTRY_GREEN_RELAY=
APP_DEVICE_L10_EXIT_RED_RELAY=A10
APP_DEVICE_L10_EXIT_GREEN_RELAY=
APP_DEVICE_L10_EXIT_TRIGGER_INPUT_KEY=B10

APP_DEVICE_L11_ENTRY_RED_RELAY=A10
APP_DEVICE_L11_ENTRY_GREEN_RELAY=
APP_DEVICE_L11_EXIT_RED_RELAY=A11
APP_DEVICE_L11_EXIT_GREEN_RELAY=
